  ...
  return (
    <footer className="bg-neutral-50 border-t border-neutral-200">
      <div className="flex flex-col justify-center bg-sky-900">
        ...
        <div className="flex justify-center items-center px-16 py-9 w-full bg-stone-950 max-md:px-5 max-md:max-w-full">
          <div className="max-w-full w-[1206px]">
            <div className="flex gap-5 max-md:flex-col max-md:gap-0">
              <div className="flex flex-col w-[15%] max-md:ml-0 max-md:w-full">
                <div className="flex flex-col text-sm font-semibold leading-5 text-white max-md:mt-10">
                  <div className="flex gap-1 whitespace-nowrap">
                    ...
                    />
                    <div className="flex-auto my-auto">1-xxx-xxx-xxxx</div>
                  </div>
                  <div className="flex gap-1 mt-4 whitespace-nowrap">
                    ...
                    />
                    <div className="flex-auto">info@website.ca</div>
                  </div>
                  <div className="flex gap-1 mt-4">
                    ...
                    />
                    <div className="flex-auto">Hours: Monday – Friday</div>
                  </div>
                  <div className="mt-1.5">10:30am – 7:30pm EST</div>
                </div>
              </div>
              ...
              <div className="flex flex-col ml-5 w-[23%] max-md:ml-0 max-md:w-full">
                <img
                  loading="lazy"
                  srcSet="..."
                  className="shrink-0 w-64 max-w-full aspect-[2.13] max-md:mt-10"
                />
              </div>
            </div>
          </div>
